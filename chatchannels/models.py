...
class Chat(models.Model):
    ...
    participant1 = models.ForeignKey(User, related_name='user1', on_delete=models.DO_NOTHING)
    participant2 = models.ForeignKey(User, related_name='user2', on_delete=models.DO_NOTHING)
